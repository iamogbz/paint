        ...
        <div style=${this.renderStyleObject(modalStyle)} @click=${(e: Event) => e.stopPropagation()}>
          ...
          <div style="padding: 1.25rem 1.5rem; border-bottom: 3px solid #000000; display: flex; align-items: center; justify-content: space-between; background-color: #E9C46A;">
            ...
            <button
              ...
              style="background: none; border: none; cursor: pointer; padding: 0.25rem; display: flex; align-items: center; justify-content: center; border-radius: 50%; hover:bg-black/10 transition-colors"
            >
              ${iconX(24, "#000000")}
            </button>
          </div>
              ...
              return html`
                ...
                >
                  ...
                  <div style="padding: 0.75rem; display: flex; flex-direction: column; gap: 0.25rem;">
                    <h3 style="margin: 0; font-size: 0.875rem; font-weight: 900; color: #000000;">
                      ${challenge.name}
                    </h3>
                  </div>
                </div>
