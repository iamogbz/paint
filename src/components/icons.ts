...
export const iconFolderOpen = (size = 16, color = "currentColor") => svg`
...
export const iconDownload = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconImage = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconLoader2 = (size = 24, color = "#E63946") => svg`
...
export const iconSparkles = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconUpload = (size = 32, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
...
export const iconPaintBucket = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconEye = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconSplit = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M16 3h5v5" />
    <path d="M8 3H3v5" />
...
export const iconPalette = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconPaintbrush = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconCheck = (size = 14, color = "currentColor") => svg`
...
export const iconCheckCircle2 = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconTrash2 = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 6h18" />
...
export const iconGalleryVertical = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 3h18" />
    <path d="M3 21h18" />
...
export const iconX = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M18 6 6 18" />
    <path d="m6 6 12 12" />
  </svg>
...
export const iconZoomIn = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconZoomOut = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="11" cy="11" r="8" />
    <line x1="21" y1="21" x2="16.65" y2="16.65" />
    <line x1="8" y1="11" x2="14" y2="11" />
...
export const iconRotateCcw = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconMove = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconEdit2 = (size = 16, color = "currentColor") => svg`
...
export const iconChevronLeft = (size = 24, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="m15 18-6-6 6-6" />
  </svg>
`;

export const iconChevronRight = (size = 24, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="m9 18 6-6-6-6" />
  </svg>
`;

export const iconPlus = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
export const iconCalendar = (size = 16, color = "currentColor") => svg`
  <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M8 2v3" />
    <path d="M16 2v3" />
